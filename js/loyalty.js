...
function leastVotes(array) {
    ...
    for (var i = 0; i < newarray.length; i++) {
        ...
        } else if (least[least.length - 1].votes_with_party_pct == newarray[i].votes_with_party_pct) {
            least.push(newarray[i])
        } else {
            break;
        }
...
function mostVotes(array) {
    ...
    for (var i = 0; i < newarray.length; i++) {
        ...
        } else if (most[most.length - 1].votes_with_party_pct == newarray[i].votes_with_party_pct) {
            most.push(newarray[i])
        } else {
            break;
        }
...
function printTableMost(array) {
    ...
    for (var i = 0; i < array.length; i++) {
        ...
        td2.append(array[i].total_votes);
        td3.append(array[i].votes_with_party_pct + " %");
